...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "SmsUI" /productName "SmsUI" > NUL
...
COPY /Y "SmsUI.msha" HelpContentSetup.msha
